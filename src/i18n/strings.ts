...
export const strings = {
  en: {
    ...
    rsvp: {
      ...
      guestDietary: 'Guest dietary requirements',
      weddingQuestion: 'Will you join us for the Wedding (27 Feb 2027)?',
      yes: 'Yes',
      no: 'No',
      dietary: 'Your dietary requirements',
      dietaryOptions: {
      ...
      errors: {
        ...
        weddingAttendingRequired: 'Please let us know if you\'ll be at the wedding.',
  ...
  hi: {
    ...
    rsvp: {
      ...
      removeGuest: 'अतिथि हटाएँ',
      guestName: 'अतिथि का नाम',
      guestDietary: 'अतिथि की भोजन संबंधी आवश्यकताएँ',
      weddingQuestion: 'क्या आप शादी (27 फ़रवरी 2027) में आएंगे?',
      yes: 'हाँ',
      no: 'नहीं',
      dietary: 'आपकी भोजन संबंधी आवश्यकताएँ',
      dietaryOptions: {
        vegetarian: 'शाकाहारी',
        vegan: 'विगन',
        jain: 'जैन',
      ...
      errors: {
        ...
        weddingAttendingRequired: 'कृपया बताएँ कि क्या आप शादी में आएंगे।',
